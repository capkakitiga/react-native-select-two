...
class Select2 extends Component {
    ...
    clearSelection() {
        ...
        this.setState({ data, keyword: '', selectedItem: [] });
    }
        ...
        return (
            <TouchableOpacity
                ...
                <Icon style={styles.itemIcon}
                    name={item.checked ? 'check-circle' : 'plus-circle'}
    ...
    render() {
        let {
            ...
            isInvisible, invisibleContent, resetOnOpen
        } = this.props;
        ...
        return (
            <TouchableOpacity
                ...
                activeOpacity={0.7}
                style={isInvisible?{}:[styles.container, style]}>
                <Modal
                    ...
                    <Animated.View style={[styles.modalContainer, modalStyle, { height: this.animatedHeight }]}>
                        ...
                        <View style={styles.buttonWrapper}>
                            ...
                            <Button
                                ...
                                title={resetOnOpen?'Simpan':selectButtonText}
                ...
                {
                    isInvisible ? invisibleContent() : (
                        preSelectedItem.length > 0
                        ? (
                            isSelectSingle
                                ? <Text style={[styles.selectedTitlte, this.defaultFont, selectedTitleStyle, { color: '#666' }]}>{preSelectedItem[0].name}</Text>
